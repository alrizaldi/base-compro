...
export default function AdminStoresPage() {
  ...
  async function handleExport() {
    window.open("/api/stores-export", "_blank");
  }
  ...
  async function handleImport() {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error || "Failed to import stores");
        setImporting(false);
        return;
      }
            ...
            <div className="space-y-4">
              <div className="rounded-md bg-blue-50 p-3 text-sm text-blue-800">
                ...
                <ul className="list-disc list-inside space-y-0.5 text-xs">
                  <li>Columns: ID, Name, Address, City, Phone, Image URL</li>
                  <li>Leave ID empty to create new stores</li>
                  <li>Stores with matching ID will be updated</li>
                </ul>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">

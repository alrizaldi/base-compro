        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center gap-2">
              {logoUrl ? (
                ...
                <span className="text-2xl font-bold text-[#8AAAE5]">
                  {logoText}
                </span>
              )}
            </Link>
              ...
              <Link
                ...
                className={`px-2 py-2 text-sm lg:text-base xl:px-3 2xl:px-4 rounded-md transition-colors ${
                  isActive(link.href)
                    ...
                    : "text-gray-700 hover:text-[#8AAAE5] hover:bg-blue-50"
                }`}
              >
                {link.name}
              </Link>
          ...
          <div className="md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-[#8AAAE5] hover:bg-blue-50 focus:outline-none"
